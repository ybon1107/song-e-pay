      ...
      >
        <div class="d-none d-xl-block">
          ...
          <h4 class="text-center">
            Our payment system is only available in a mobile environment.
          </h4>
        </div>
        <div class="d-xl-none">
          <div
          ...
          >
            <div
              ...
              :style="{ backgroundImage: 'url(/images/won-e-money.png)' }"
            ></div>
            <router-link to="/payment/password">
              <button class="btn btn-warning mb-0">결제하기</button>
              <!-- <div>
