        ...
        <div class="modal-body">
          <div class="filter-options">
            ...
            <div class="row mb-3">
              ...
              <div class="btn-group">
                <button class="btn btn-outline-primary" @click="selectPeriod('Today')">오늘</button>
                <button class="btn btn-outline-primary" @click="selectPeriod('Last Month')">1개월</button>
                <button class="btn btn-outline-primary" @click="selectPeriod('Last 3 Month')">3개월</button>
                <button class="btn btn-outline-primary" @click="selectCustomDate">직접설정</button>
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="btn-group">
                <button class="btn btn-outline-secondary" @click="filters.selectedType = 'All'">전체</button>
                <button class="btn btn-outline-secondary" @click="filters.selectedType = 'SongEaccount'">송이계좌</button>
                <button class="btn btn-outline-secondary" @click="filters.selectedType = 'KRaccount'">원화계좌</button>
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <div class="btn-group">
                <button class="btn btn-outline-secondary" @click="filters.selectedSort = 'Newest'">최신순</button>
                <button class="btn btn-outline-secondary" @click="filters.selectedSort = 'Oldest'">과거순</button>
              </div>
            </div>
          </div>
        </div>
