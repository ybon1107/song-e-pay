    ...
    <div class="password-page page-size">
        <div class="page-size password-container">
            <form class="password-box" @submit.prevent="changePassword">
                ...
                <input class="form-control pwd-input" type="password" v-model="password" name="password" id="password"
                    style="margin-bottom: 5px;">

                <label for="password2" class="form-control-label">비밀번호 확인</label>
                <input class="form-control pwd-input" type="password" v-model="password2" name="password"
                    id="password2">
