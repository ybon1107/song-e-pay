<template>
    <nav style="
            ...
            height: 70px;
        ">
        <div class="container h-100 w-100 d-flex align-items-center justify-content-between">
            <a href="/" class="mb-0 text-white text-decoration-none">
    ...
    <div class="section-container-beige">
        <h3 class="mb-4 mobile-btn text-center font_2">
            Make traveling in Korea more convenient<br />with our easy to use
            E-wallet service
        </h3>
        <div class="d-flex justify-content-between flex-column flex-md-row align-items-start">
            ...
            <div class="left-section-main d-flex flex-column mt-2 col-md-6">
                <h3 class="mb-4 text-nowrap web-btn font_2">
                    Make traveling in Korea more convenient<br />with our easy
                    to use E-wallet service
                </h3>

                <p class="col-md-9 mb-4">
                    For foreigners traveling to South Korea, we provide secure
                    and fast payment and currency exchange services. From
                    checking live exchange rates to sending money to friends,
                    you can easily access all your financial services in one
                    place.
                </p>
                <!-- 모바일 버전 버튼 -->
                <a href="/login" class="btn mobile-btn col-md-3 mb-4">Get Started</a>
                <!-- 웹 버전 버튼 -->
                <a href="/login" class="btn web-btn col-md-5 mb-4">Get Started</a>

                <!-- 아이콘 섹션 -->
                <div class="icon-item d-flex flex-wrap mb-3">
                    <div class="icon-item col-md-4 col-12 d-flex align-items-center">
                        <div style="
                                position: relative;
                                width: 50px;
                                height: 50px;
                        ...
                        <div class="ms-2 web-btn">
                            <div style="font-size: 0.85rem">Speed &</div>
                            <div style="font-size: 0.85rem">Security</div>
                        </div>
                        <div class="mobile-btn">Speed & Security</div>
                    </div>
                    <div class="icon-item col-md-4 col-12 d-flex align-items-center">
                        <div style="
                                position: relative;
                        ...
                        <div class="ms-2 web-btn">
                            <div style="font-size: 0.85rem">Easy &</div>
                            <div style="font-size: 0.85rem">Simple</div>
                        </div>
                        <div class="mobile-btn">Easy & Simple</div>
                    </div>
                    <div class="icon-item col-md-4 col-12 d-flex align-items-center">
                        <div style="
                                position: relative;
                        ...
                        <div class="ms-2 web-btn">
                            <div style="font-size: 0.85rem">Local &</div>
                            <div style="font-size: 0.85rem">Global</div>
                        </div>
                        <div class="mobile-btn">Local & Global</div>
                    </div>
                </div>
            </div>
    ...
    <div class="section-container-beige">
        ...
        <div class="d-flex flex-wrap mb-3 gap-4">
            <!-- What We Offer 섹션 -->
            <h2 class="font_2">About Song-E Pay!</h2>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 pe-4">
                    <div class="card">
                        ...
                        <div class="col-md-9 web-btn">
                            <div class="d-flex">
                                ...
                                <h3>Your essential travel partner</h3>
                            </div>
                            <div class="d-flex justify-content-end">
                                <h3 class="text-end">be your essential travel partner</h3>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <p>Make travel finance easier, smarter in Korea</p>
                            <p style="text-align: justify">
                                Simplify your finances Song-E Pay provides foreigners
                                traveling to Korea with real-time exchange rates, automatic
                                currency conversion, automatic currency conversion, and easy
                                money transfer. Exchange money and make payments easily
                                Manage your Pay Money account and bank map service to make
                                your local financial Make your life easier with automatic
                                trip logs based on your payment history Calendar makes it
                                easy to organize your memories.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-container-beige">
                    ...
                    <div class="d-flex flex-wrap mb-3 gap-4">
                        ...
                        <h2 class="font_2">About Song-E Pay!</h2>
                        <div class="col-md-9 mb-4">
                            From live exchange rates to automated conversions and alerts,
                            we're here to help you find the best deals and make your
                            currency exchange quick and easy. Stay on top of currency
                            fluctuations and get the best exchange rate for your money.
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 pe-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="image-container">
                                            <img class="flex_item_image" src="../../../images/image1.png"
                                                alt="실시간 환율 조회" />
                                        </div>
                                    </div>
                                </div>
                                <div class="text-container">
                                    <h5 class="font_5">Get live currency exchange rates</h5>
                                    <p class="lh-sm text-sm">
                                        Get the latest exchange rates anytime before,
                                        during, or after your trip, and make the best
                                        currency conversions as exchange rates fluctuate.
                                    </p>
                                </div>
                                <div class="p-3 mobile-btn"></div>
                            </div>
                            ...
                            <section class="section-container-brown">
                                ...
                                <div class="mobile-btn">
                                    <h3 class="font_2 color-light-beige text-center mb-4">Pay Money account & Send money
                                        between Korean won-only accounts</h3>
                                </div>

                                <div
                                    class="d-flex justify-content-between align-items-center flex-column flex-md-row mb-3 color-beige">
                                    <div class="mesh-left col-md-7 d-flex flex-column px-3">
                                        ...
                                        <p class="fw-bold fs-5 mb-1">Easily send money in Korean won!</p>
                                        <p style="text-align: justify;" class="lh-sm">
                                    ...
                                    <div
                                        class="mesh-right col-md-5 col-12 d-flex justify-content-end align-items-center">
                            ...
                            <div class="col-lg-3 col-md-6 px-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="image-container">
                                            <img class="flex_item_image" src="../../../images/image3.png"
                                                alt="환율 알림 서비스" />
                                        </div>
                                    </div>
                                </div>
                                <div class="text-container">
                                    <h5 class="font_5">Exchange Rate Alert Service</h5>
                                    <p class="lh-sm text-sm">
                                        Get instant notifications when your desired exchange
                                        rate is reached so you can make your conversion at
                                        the optimal time.
                                    </p>
                                </div>
                                <div class="p-3 mobile-btn"></div>
                            ...
                            <div class="col-lg-3 col-md-6 ps-4">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="image-container">
                                            <img class="flex_item_image" src="../../../images/image4.png"
                                                alt="No 수수료! 자유로운 환전" />
                                        </div>
                                    </div>
                                </div>
                                <div class="text-container">
                                    <h5 class="font_5">No fees! Free currency exchange</h5>
                                    <p class="lh-sm text-sm">
                                        We'll give you a Pay Money account to manage the
                                        money you exchange. Exchange money anytime,
                                        anywhere, without worrying about fees.
                                    </p>
                                </div>
                                <div class="p-3 mobile-btn"></div>
                            </div>
            ...
            <section class="section-container-brown">
                ...
                <div class="d-flex justify-content-between align-items-center flex-column flex-md-row mb-3 color-beige">
                    <div class="mesh-left col-md-7 d-flex flex-column px-3">
                        <p class="fw-bold fs-5 mb-1">Manage your money in one place!</p>
                        <p style="text-align: justify" class="lh-sm">
                            Manage multiple currencies easily with a Pay Money account.
                            Store your currency conversions and make quick payments and
                            transfers whenever you need them.
                        </p>
                        <p class="fw-bold fs-5 mb-1">
                            Easily send money in Korean won!
                        </p>
                        <p style="text-align: justify" class="lh-sm">
                            Easily send money to friends locally with a dedicated Korean
                            Won account. No bank account required, all you need is Pay
                            Money to send money quickly and securely with just a few
                            clicks.
                        </p>
                        <p class="fw-bold fs-5 mb-1">
                            Quick and easy payments and transfers on the go!
                        ...
                        <p style="text-align: justify" class="lh-sm">
                            Smartly manage your currency conversion and have it at your
                            fingertips when you need it. Pay and send money in KRW
                            instantly, even in Korea, without worrying about exchange
                            rates.
                        </p>
                    </div>
            ...
            <section class="section-container-beige">
                <div class="d-flex justify-content-between align-items-center flex-column flex-md-row">
                    <div class="mesh-right col-md-5 col-12 d-flex justify-content-center align-items-center mb-4">
                        <img src="../../../images/Map.png" alt="지도 이미지" class="img-fluid"
                            style="max-width: 100%; height: auto" />
                    </div>
                    <div class="mesh-left col-md-7 d-flex flex-column px-3">
                        ...
                        <p>
                            ...
                            Use our map to find your nearest branch and get your
                            financial needs taken care of quickly.
                        </p>
                    </div>
                </div>
            </section>
            <!-- 다섯 번째 섹션 -->
            <section class="section-container-beige">
                <div class="lastpage d-flex justify-content-between align-items-center flex-column gap-3">
                    <div class="d-flex">
                        <div class="small-img-container me-2">
                            <img src="/images/quote.png" class="small-img" />
                        </div>
